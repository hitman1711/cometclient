#
#  Be sure to run `pod spec lint cometclient.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of cometclient in Markdown format.
...
s.source = { :git => "https://github.com/hitman1711/cometclient.git"}
  ...
  s.public_header_files = "DDComet/*.h"
